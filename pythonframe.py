...
from assetlib import python_pic
class PythonFrame(ctk.CTkFrame):
    ...
    def setup_game_over_frame(self):
        ...
        self.python_label = ctk.CTkLabel(self, text="Python" ,
                                               anchor='center',font=("Old English Text",40,"bold"))
        self.python_label.place(relx=0.45, rely=0.015)
        self.python_logo_label = ctk.CTkLabel(self, image=python_pic, text="",
										                 font=ctk.CTkFont(size=20, weight="bold"))
        self.python_logo_label.place(relx = 0.32 , rely = 0.013 )
        
        self.back_main_menu = ctk.CTkLabel(self,text='<--',font=("Old English Text",20,"bold"))
        self.back_main_menu.place(relx=0.2,rely=0.02)
        self.back_main_menu.bind("<Button-1>", lambda event: self.master.open_main_menu_frame("python_frame"))
